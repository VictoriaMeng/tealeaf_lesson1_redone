...
def player_is_rock(opponent_hand)
...
def player_is_paper(opponent_hand)
  if opponent_hand == "rock"
...
def player_is_scissors(opponent_hand)
  if opponent_hand == "rock"
...
loop do
  ...
  if input.downcase == "r" || input.downcase == "rock"
    say player_is_rock(opponent_hand)
  elsif input.downcase == "p" || input.downcase == "paper"
    say player_is_paper(opponent_hand)
  elsif input.downcase == "s" || input.downcase == "scissors"
    say player_is_scissors(opponent_hand)
  else
